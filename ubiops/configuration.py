...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ubiops.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the ubiops.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ubiops.Configuration(
        signing_info = ubiops.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host=None, api_key=None, api_key_prefix=None, username=None, password=None, signing_info=None):
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ubiops")

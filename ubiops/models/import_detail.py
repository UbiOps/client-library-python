...
class ImportDetail(object):
    ...
    def services(self):
        """
        Gets the services of this ImportDetail

        :return: the services of this ImportDetail
        :rtype: dict(str, object)
        """
    ...
    def services(self, services):
        """
        Sets the services of this ImportDetail

        :param services: the services of this ImportDetail
        :type: dict(str, object)
        """

        if self.client_side_validation and (services is not None and not isinstance(services, dict)):
            raise ValueError("Parameter `services` must be a dictionary")

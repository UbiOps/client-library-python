...
class PipelineList(object):
    ...
    def id(self):
        """
        Gets the id of this PipelineList

        :return: the id of this PipelineList
        :rtype: str
        """
    ...
    def id(self, id):
        ...
        :param id: the id of this PipelineList
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this PipelineList

        :return: the name of this PipelineList
        :rtype: str
        """
    ...
    def name(self, name):
        ...
        :param name: the name of this PipelineList
        :type: str
        """
    ...
    def project(self):
        """
        Gets the project of this PipelineList

        :return: the project of this PipelineList
        :rtype: str
        """
    ...
    def project(self, project):
        ...
        :param project: the project of this PipelineList
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this PipelineList

        :return: the description of this PipelineList
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: the description of this PipelineList
        :type: str
        """
    ...
    def input_type(self):
        """
        Gets the input_type of this PipelineList

        :return: the input_type of this PipelineList
        :rtype: str
        """
    ...
    def input_type(self, input_type):
        ...
        :param input_type: the input_type of this PipelineList
        :type: str
        """
    ...
    def input_fields(self):
        """
        Gets the input_fields of this PipelineList

        :return: the input_fields of this PipelineList
    ...
    def input_fields(self, input_fields):
        ...
        :param input_fields: the input_fields of this PipelineList
        :type: list[InputOutputFieldList]
        """

        if self.client_side_validation and input_fields is None:
    ...
    def output_type(self):
        """
        Gets the output_type of this PipelineList

        :return: the output_type of this PipelineList
        :rtype: str
        """
    ...
    def output_type(self, output_type):
        ...
        :param output_type: the output_type of this PipelineList
        :type: str
        """
    ...
    def output_fields(self):
        """
        Gets the output_fields of this PipelineList

        :return: the output_fields of this PipelineList
        :rtype: list[InputOutputFieldList]
        """
    ...
    def output_fields(self, output_fields):
        ...
        :param output_fields: the output_fields of this PipelineList
        :type: list[InputOutputFieldList]
        """

        if self.client_side_validation and output_fields is None:
    ...
    def labels(self):
        """
        Gets the labels of this PipelineList

        :return: the labels of this PipelineList
        :rtype: dict(str, str)
        """
    ...
    def labels(self, labels):
        ...
        :param labels: the labels of this PipelineList
        :type: dict(str, str)
        """
    ...
    def creation_date(self):
        """
        Gets the creation_date of this PipelineList

        :return: the creation_date of this PipelineList
        :rtype: datetime
        """
    ...
    def creation_date(self, creation_date):
        ...
        :param creation_date: the creation_date of this PipelineList
        :type: datetime
        """
    ...
    def last_updated(self):
        """
        Gets the last_updated of this PipelineList

        :return: the last_updated of this PipelineList
        :rtype: datetime
        """
    ...
    def last_updated(self, last_updated):
        ...
        :param last_updated: the last_updated of this PipelineList
        :type: datetime
        """

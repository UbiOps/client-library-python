...
class EnvironmentRevisionCreate(object):
    ...
    def __init__(self, success=None, revision=None, build=None, **kwargs):
        """
        EnvironmentRevisionCreate - a model defined in OpenAPI
        """
    ...
    def success(self):
        """
        Gets the success of this EnvironmentRevisionCreate

        :return: the success of this EnvironmentRevisionCreate
        :rtype: bool
        """
    ...
    def success(self, success):
        ...
        :param success: the success of this EnvironmentRevisionCreate
        :type: bool
        """
    ...
    def revision(self):
        """
        Gets the revision of this EnvironmentRevisionCreate

        :return: the revision of this EnvironmentRevisionCreate
        :rtype: str
        """
    ...
    def revision(self, revision):
        ...
        :param revision: the revision of this EnvironmentRevisionCreate
        :type: str
        """
    ...
    def build(self):
        """
        Gets the build of this EnvironmentRevisionCreate

        :return: the build of this EnvironmentRevisionCreate
        :rtype: str
        """
    ...
    def build(self, build):
        ...
        :param build: the build of this EnvironmentRevisionCreate
        :type: str
        """

        if self.client_side_validation and build is None:

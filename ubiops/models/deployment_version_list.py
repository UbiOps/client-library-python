...
class DeploymentVersionList(object):
    ...
    def maximum_queue_size(self):
        """
        Gets the maximum_queue_size of this DeploymentVersionList

        :return: the maximum_queue_size of this DeploymentVersionList
        :rtype: int
        """
    ...
    def maximum_queue_size(self, maximum_queue_size):
        """
        Sets the maximum_queue_size of this DeploymentVersionList

        :param maximum_queue_size: the maximum_queue_size of this DeploymentVersionList
        :type: int
        """

        if self.client_side_validation and (maximum_queue_size is not None and not isinstance(maximum_queue_size, int)):
            raise ValueError("Parameter `maximum_queue_size` must be an integer")

...
class DeploymentInstanceType(object):
    ...
    def __init__(self, id=None, name=None, display_name=None, memory_allocation=None, cpu_allocation=None, gpu_allocation=None, storage_allocation=None, local_vars_configuration=None, **kwargs):  # noqa: E501

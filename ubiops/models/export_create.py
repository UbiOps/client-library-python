...
class ExportCreate(object):
    ...
    def deployments(self):
        """
        Gets the deployments of this ExportCreate

        :return: the deployments of this ExportCreate
    ...
    def deployments(self, deployments):
        ...
        :param deployments: the deployments of this ExportCreate
    ...
    def pipelines(self):
        """
        Gets the pipelines of this ExportCreate

        :return: the pipelines of this ExportCreate
        :rtype: dict(str, object)
        """
    ...
    def pipelines(self, pipelines):
        ...
        :param pipelines: the pipelines of this ExportCreate
        :type: dict(str, object)
        """
    ...
    def environment_variables(self):
        """
        Gets the environment_variables of this ExportCreate

        :return: the environment_variables of this ExportCreate
        :rtype: dict(str, object)
        """
    ...
    def environment_variables(self, environment_variables):
        ...
        :param environment_variables: the environment_variables of this ExportCreate
        :type: dict(str, object)
        """
    ...
    def environments(self):
        """
        Gets the environments of this ExportCreate

        :return: the environments of this ExportCreate
        :rtype: dict(str, object)
        """
    ...
    def environments(self, environments):
        ...
        :param environments: the environments of this ExportCreate
        :type: dict(str, object)
        """
    ...
    def services(self):
        """
        Gets the services of this ExportCreate

        :return: the services of this ExportCreate
        :rtype: dict(str, object)
        """
    ...
    def services(self, services):
        """
        Sets the services of this ExportCreate

        :param services: the services of this ExportCreate
        :type: dict(str, object)
        """

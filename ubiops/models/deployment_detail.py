...
class DeploymentDetail(object):
    ...
    def id(self):
        """
        Gets the id of this DeploymentDetail

        :return: the id of this DeploymentDetail
        :rtype: str
        """
    ...
    def id(self, id):
        ...
        :param id: the id of this DeploymentDetail
        :type: str
        """
    ...
    def supports_request_format(self):
        """
        Gets the supports_request_format of this DeploymentDetail

        :return: the supports_request_format of this DeploymentDetail
        :rtype: bool
        """
    ...
    def supports_request_format(self, supports_request_format):
        """
        Sets the supports_request_format of this DeploymentDetail

        :param supports_request_format: the supports_request_format of this DeploymentDetail
        :type: bool
        """
    ...
    def project(self):
        """
        Gets the project of this DeploymentDetail

        :return: the project of this DeploymentDetail
        :rtype: str
        """
    ...
    def project(self, project):
        """
        Sets the project of this DeploymentDetail

        :param project: the project of this DeploymentDetail
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this DeploymentDetail

        :return: the description of this DeploymentDetail
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: the description of this DeploymentDetail
        :type: str
        """
    ...
    def input_type(self):
        """
        Gets the input_type of this DeploymentDetail

        :return: the input_type of this DeploymentDetail
        :rtype: str
        """
    ...
    def input_type(self, input_type):
        """
        Sets the input_type of this DeploymentDetail

        :param input_type: the input_type of this DeploymentDetail
        :type: str
        """
    ...
    def output_type(self):
        """
        Gets the output_type of this DeploymentDetail

        :return: the output_type of this DeploymentDetail
        :rtype: str
        """
    ...
    def output_type(self, output_type):
        """
        Sets the output_type of this DeploymentDetail

        :param output_type: the output_type of this DeploymentDetail
        :type: str
        """
    ...
    def input_fields(self):
        """
        Gets the input_fields of this DeploymentDetail

        :return: the input_fields of this DeploymentDetail
    ...
    def input_fields(self, input_fields):
        """
        Sets the input_fields of this DeploymentDetail

        :param input_fields: the input_fields of this DeploymentDetail
    ...
    def output_fields(self):
        """
        Gets the output_fields of this DeploymentDetail

        :return: the output_fields of this DeploymentDetail
        :rtype: list[InputOutputFieldDetail]
        """
    ...
    def output_fields(self, output_fields):
        """
        Sets the output_fields of this DeploymentDetail

        :param output_fields: the output_fields of this DeploymentDetail
        :type: list[InputOutputFieldDetail]
        """
    ...
    def labels(self):
        """
        Gets the labels of this DeploymentDetail

        :return: the labels of this DeploymentDetail
        :rtype: dict(str, str)
        """
    ...
    def labels(self, labels):
        """
        Sets the labels of this DeploymentDetail

        :param labels: the labels of this DeploymentDetail
        :type: dict(str, str)
        """
    ...
    def creation_date(self):
        """
        Gets the creation_date of this DeploymentDetail

        :return: the creation_date of this DeploymentDetail
        :rtype: datetime
        """
    ...
    def creation_date(self, creation_date):
        """
        Sets the creation_date of this DeploymentDetail

        :param creation_date: the creation_date of this DeploymentDetail
        :type: datetime
        """
    ...
    def last_updated(self):
        """
        Gets the last_updated of this DeploymentDetail

        :return: the last_updated of this DeploymentDetail
        :rtype: datetime
        """
    ...
    def last_updated(self, last_updated):
        """
        Sets the last_updated of this DeploymentDetail

        :param last_updated: the last_updated of this DeploymentDetail
        :type: datetime
        """
    ...
    def default_version(self):
        """
        Gets the default_version of this DeploymentDetail

        :return: the default_version of this DeploymentDetail
        :rtype: str
        """
    ...
    def default_version(self, default_version):
        """
        Sets the default_version of this DeploymentDetail

        :param default_version: the default_version of this DeploymentDetail
        :type: str
        """

...
class UserPendingCreate(object):
    ...
    def email(self, email):
        ...
        :param email: the email of this UserPendingCreate
        :type: str
        """
    ...
    def password(self):
        """
        Gets the password of this UserPendingCreate

        :return: the password of this UserPendingCreate
        :rtype: str
        """
    ...
    def password(self, password):
        ...
        :param password: the password of this UserPendingCreate
        :type: str
        """

        if self.client_side_validation and password is None:
            raise ValueError("Invalid value for `password`, must not be `None`")
        if self.client_side_validation and (password is not None and not isinstance(password, str)):
            raise ValueError("Parameter `password` must be a string")

        if self.client_side_validation and (password is not None and len(password) > 128):
            raise ValueError("Invalid value for `password`, length must be less than or equal to `128`")
        if self.client_side_validation and (password is not None and len(password) < 1):
    ...
    def name(self):
        """
        Gets the name of this UserPendingCreate

        :return: the name of this UserPendingCreate
        :rtype: str
        """
    ...
    def name(self, name):
        ...
        :param name: the name of this UserPendingCreate
        :type: str
        """
    ...
    def surname(self):
        """
        Gets the surname of this UserPendingCreate

        :return: the surname of this UserPendingCreate
        :rtype: str
        """
    ...
    def surname(self, surname):
        ...
        :param surname: the surname of this UserPendingCreate
        :type: str
        """

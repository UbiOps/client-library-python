...
class PipelineCreate(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        PipelineCreate - a model defined in OpenAPI
        """
    ...
    def name(self):
        """
        Gets the name of this PipelineCreate

        :return: the name of this PipelineCreate
        :rtype: str
        """
    ...
    def name(self, name):
        ...
        :param name: the name of this PipelineCreate
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this PipelineCreate

        :return: the description of this PipelineCreate
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: the description of this PipelineCreate
        :type: str
        """
    ...
    def input_type(self):
        """
        Gets the input_type of this PipelineCreate

        :return: the input_type of this PipelineCreate
        :rtype: str
        """
    ...
    def input_type(self, input_type):
        ...
        :param input_type: the input_type of this PipelineCreate
        :type: str
        """
    ...
    def input_fields(self):
        """
        Gets the input_fields of this PipelineCreate

        :return: the input_fields of this PipelineCreate
    ...
    def input_fields(self, input_fields):
        ...
        :param input_fields: the input_fields of this PipelineCreate
    ...
    def output_type(self):
        """
        Gets the output_type of this PipelineCreate

        :return: the output_type of this PipelineCreate
        :rtype: str
        """
    ...
    def output_type(self, output_type):
        ...
        :param output_type: the output_type of this PipelineCreate
        :type: str
        """
    ...
    def output_fields(self):
        """
        Gets the output_fields of this PipelineCreate

        :return: the output_fields of this PipelineCreate
    ...
    def output_fields(self, output_fields):
        ...
        :param output_fields: the output_fields of this PipelineCreate
    ...
    def labels(self):
        """
        Gets the labels of this PipelineCreate

        :return: the labels of this PipelineCreate
        :rtype: dict(str, str)
        """
    ...
    def labels(self, labels):
        ...
        :param labels: the labels of this PipelineCreate
        :type: dict(str, str)
        """

...
class ProjectDetail(object):
    ...
    def id(self):
        """
        Gets the id of this ProjectDetail

        :return: the id of this ProjectDetail
        :rtype: str
        """
    ...
    def id(self, id):
        ...
        :param id: the id of this ProjectDetail
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this ProjectDetail

        :return: the name of this ProjectDetail
        :rtype: str
        """
    ...
    def name(self, name):
        ...
        :param name: the name of this ProjectDetail
        :type: str
        """
    ...
    def advanced_permissions(self):
        """
        Gets the advanced_permissions of this ProjectDetail

        :return: the advanced_permissions of this ProjectDetail
        :rtype: bool
        """
    ...
    def advanced_permissions(self, advanced_permissions):
        ...
        :param advanced_permissions: the advanced_permissions of this ProjectDetail
        :type: bool
        """
    ...
    def credits(self):
        """
        Gets the credits of this ProjectDetail

        :return: the credits of this ProjectDetail
        :rtype: float
        """
    ...
    def credits(self, credits):
        ...
        :param credits: the credits of this ProjectDetail
        :type: float
        """
    ...
    def organization_name(self):
        """
        Gets the organization_name of this ProjectDetail

        :return: the organization_name of this ProjectDetail
        :rtype: str
        """
    ...
    def organization_name(self, organization_name):
        ...
        :param organization_name: the organization_name of this ProjectDetail
        :type: str
        """
    ...
    def suspended_reason(self):
        """
        Gets the suspended_reason of this ProjectDetail

        :return: the suspended_reason of this ProjectDetail
        :rtype: str
        """
    ...
    def suspended_reason(self, suspended_reason):
        ...
        :param suspended_reason: the suspended_reason of this ProjectDetail
        :type: str
        """

        if self.client_side_validation and (suspended_reason is not None and not isinstance(suspended_reason, str)):
            raise ValueError("Parameter `suspended_reason` must be a string")
    ...
    def cors_origins(self):
        """
        Gets the cors_origins of this ProjectDetail

        :return: the cors_origins of this ProjectDetail
        :rtype: list[str]
        """
    ...
    def cors_origins(self, cors_origins):
        """
        Sets the cors_origins of this ProjectDetail

        :param cors_origins: the cors_origins of this ProjectDetail
        :type: list[str]
        """

...
class ServiceUserTokenList(object):
    ...
    def __init__(self, token=None, **kwargs):
        """
        ServiceUserTokenList - a model defined in OpenAPI
        """
    ...
    def token(self):
        """
        Gets the token of this ServiceUserTokenList

        :return: the token of this ServiceUserTokenList
        :rtype: str
        """
    ...
    def token(self, token):
        ...
        :param token: the token of this ServiceUserTokenList
        :type: str
        """

        if self.client_side_validation and token is None:
        ...
        if self.client_side_validation and (token is not None and len(token) < 1):

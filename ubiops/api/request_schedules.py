...
class RequestSchedules(object):
    ...
    def request_schedules_create_with_http_info(self, project_name, data, **kwargs):
        """
        ...
        >>> thread = RequestSchedules.request_schedules_create_with_http_info(
        ...
        method_name = "request_schedules_create"
        optional_params = []
        additional_params = [
            "async_req",
        ...
        url = "/projects/{project_name}/schedules"  # noqa: E501
    ...
    def request_schedules_delete_with_http_info(self, project_name, schedule_name, **kwargs):
        """
        ...
        >>> thread = RequestSchedules.request_schedules_delete_with_http_info(
        ...
        method_name = "request_schedules_delete"
        optional_params = []
        additional_params = [
            "async_req",
            "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and project_name is None:
            raise ApiValueError(f"Missing the required parameter `project_name` when calling `{method_name}`")
        if self.api_client.client_side_validation and schedule_name is None:
        ...
        path_params["project_name"] = project_name
        path_params["schedule_name"] = schedule_name

        url = "/projects/{project_name}/schedules/{schedule_name}"  # noqa: E501
        return self.api_client.call_api(
            url,
            "DELETE",
            path_params,
    ...
    def request_schedules_get_with_http_info(self, project_name, schedule_name, **kwargs):
        """
        ...
        >>> thread = RequestSchedules.request_schedules_get_with_http_info(
                project_name, schedule_name, async_req=True
            )
        >>> result = thread.get()
        ...
        method_name = "request_schedules_get"
        optional_params = []
        additional_params = [
            "async_req",
            "_return_http_data_only",
    ...
    def request_schedules_list_with_http_info(self, project_name, **kwargs):
        """
        ...
        >>> thread = RequestSchedules.request_schedules_list_with_http_info(
        ...
        method_name = "request_schedules_list"
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=files,
            response_type="list[ScheduleList]",
            auth_settings=["api_key"],
            async_req=kwargs.get("async_req", False),
            _return_http_data_only=kwargs.get("_return_http_data_only", True),
            _preload_content=kwargs.get("_preload_content", True),
    ...
    def request_schedules_update_with_http_info(self, project_name, schedule_name, data, **kwargs):
        """
        ...
        >>> thread = RequestSchedules.request_schedules_update_with_http_info(
        ...
        method_name = "request_schedules_update"
        optional_params = []
        additional_params = [
            "async_req",
            "_return_http_data_only",

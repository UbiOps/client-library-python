...
# Evaluate expression
api_response = api.expressions_evaluate(data)
print(api_response)
...
# List audit events for a pipeline
api_response = api.pipeline_audit_events_list(project_name, pipeline_name, action=action, limit=limit, offset=offset)
print(api_response)
...
# List pipeline object environment variables
api_response = api.pipeline_version_object_environment_variables_list(project_name, name, pipeline_name, version)
print(api_response)
...
# Create pipeline versions
api_response = api.pipeline_versions_create(project_name, pipeline_name, data)
print(api_response)
...
# Delete pipeline version
api.pipeline_versions_delete(project_name, pipeline_name, version)
...
# Get pipeline version
api_response = api.pipeline_versions_get(project_name, pipeline_name, version)
print(api_response)
...
# List pipeline versions
api_response = api.pipeline_versions_list(project_name, pipeline_name, labels=labels)
print(api_response)
...
# Update pipeline version
api_response = api.pipeline_versions_update(project_name, pipeline_name, version, data)
print(api_response)
...
# Create pipelines
api_response = api.pipelines_create(project_name, data)
print(api_response)
...
# Delete a pipeline
api.pipelines_delete(project_name, pipeline_name)
...
# Get details of a pipeline
api_response = api.pipelines_get(project_name, pipeline_name)
print(api_response)
...
# List pipelines
api_response = api.pipelines_list(project_name, labels=labels)
print(api_response)
...
# Update a pipeline
api_response = api.pipelines_update(project_name, pipeline_name, data)
print(api_response)
